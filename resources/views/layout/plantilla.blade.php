...
<body>
    ...
    <div class="flex mt-8 mr-10">
        <button class="button text-left bg-green-600 text-white ml-10 mt-12 mx-auto px-4 py-4 w-80 shadow-md hover:bg-gradient-to-br hover:bg-green-600 transition-all duration-500 rounded-md"><a href="{{route ('registro.index')}}" >Inicio</a></button>
        <button class="button text-left bg-green-600 text-white ml-10 mt-12 mx-auto px-4 py-4 w-80 shadow-md hover:bg-gradient-to-br hover:bg-green-600 transition-all duration-500 rounded-md"><a href="{{route ('registro.create')}}" >Jugadores</a></button>
        <button class="button text-left bg-green-600 text-white ml-10 mt-12 mx-auto px-4 py-4 w-80 shadow-md hover:bg-gradient-to-br hover:bg-green-600 transition-all duration-500 rounded-md"><a href="{{route ('registro.show', 0)}}" >Equipos</a></button>
        <button class="button text-left bg-green-600 text-white ml-10 mt-12 mx-auto px-4 py-4 w-80 shadow-md hover:bg-gradient-to-br hover:bg-green-600 transition-all duration-500 rounded-md"><a href="{{route ('registro.edit', 0)}}" >Entrenadores</a></button>
